...
export const ContactFormContainer = () => {
  return (
    ...
    <div
      className=" flex md:flex lg:w-screen w-fit    lg:flex-row-reverse flex-col-reverse align-center justify-center lg:bg-whitenew pl-36"
      id="ContactSection"
    >
      ...
      <div className="flex-1 ">
        <div
          className={
            ...
            // 'lg:h-5/6 h-mobileMainImageHeight xl:w-4/5 w-full 2 bg-contain lg:bg-cover  xl:contain bg-no-repeat bg-center xl:mt-16 mt-2 2xl:ml-36 lg:ml-20'
            'lg:h-5/6 h-mobileMainImageHeight xl:w-4/5 w-full 2 bg-contain lg:bg-cover  xl:contain bg-no-repeat bg-center xl:mt-16 mt-2 2xl:ml-36 lg:ml-20'
          }
          style={{
