...
export default function NavFirstt() {
  return (
    <>
        ...
        <div id="innermainnavcontainer">
          <div class="group inline-block">
            <button class="outline-none focus:outline-none  px-3 py-1 bg-white rounded-sm flex items-center min-w-32">
              <span class="pr-1 font-semibold flex-1">Business Verticals</span>
              <span>
                <svg
  ...
  transition duration-150 ease-in-out origin-top min-w-32"
            >
              <li class="rounded-sm px-3 py-1 hover:bg-gray-100 w-40">Kalfreight</li>
              <li class="rounded-sm px-3 py-1 hover:bg-gray-100 w-40">Kalfreight</li>
              <li class="rounded-sm px-3 py-1 hover:bg-gray-100 w-40">Kalfreight</li>
              <li class="rounded-sm px-3 py-1 hover:bg-gray-100 w-40">Kalfreight</li>
              <li class="rounded-sm px-3 py-1 hover:bg-gray-100 w-40">Kalfreight</li>
